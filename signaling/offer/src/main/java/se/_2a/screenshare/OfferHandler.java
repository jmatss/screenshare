...
/**
 * Class used to "proxy" WebRTC Offer messages between two connected websockets.
 */
public class OfferHandler implements RequestHandler<APIGatewayV2WebSocketEvent, APIGatewayV2WebSocketResponse> {
    public static final String HANDLER_TYPE = Constants.OFFER;
    ...
    public APIGatewayV2WebSocketResponse handleRequest(APIGatewayV2WebSocketEvent event, Context context) {
        ...
        if (!this.conn.isConsumer(connectionId)) {
            String msg = "Not allowed to send RTC offer from producer.";
        ...
        ResponseUtil.pushToClient(producerConnectionId, body, requestContext, logger);
        return ResponseUtil.createSuccess("Offer sent", HANDLER_TYPE, logger);
    }
}
